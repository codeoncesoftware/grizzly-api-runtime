...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static List<String> clients = Arrays.asList("google", "github", "facebook", "linkedin", "gitlab");
    ...
    public void configure(WebSecurity web) {
        web.ignoring().antMatchers("/runtime/**").antMatchers("/");
    }
    ...
    private ClientRegistration getRegistration(String client) {
        String clientId = env.getProperty("spring.security.oauth2.client.registration." + client + ".client-id");
        if (clientId == null) {
            return null;
        }

        String clientSecret = env
                .getProperty("spring.security.oauth2.client.registration." + client + ".client-secret");
        ...
        if(client.equals("linkedin")) {
            ClientRegistration.Builder builder = ClientRegistration.withRegistrationId("linkedin");
        ...
        if(client.equals("gitlab")) {
            ClientRegistration.Builder builder = ClientRegistration.withRegistrationId("gitlab");
            builder.clientAuthenticationMethod(ClientAuthenticationMethod.POST);
            builder.authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE);
            builder.redirectUriTemplate("{baseUrl}/{action}/oauth2/code/{registrationId}");
